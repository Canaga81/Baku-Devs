...
//! Tiklanan'da active olan sehifeler

//? Pages

const kabinetEmail = document.querySelector( '.kabinet-email' );
const kabinetAbune = document.querySelector( '.kabinet-abune' );
const kabinetQebz = document.querySelector( '.kabinet-qebz' );
const populyarLineContainerEl = document.querySelector( '.populyar-line-container' );

//? Buttons

const profileBtn = document.getElementById( 'profile' );
const abunelikBtn = document.getElementById( 'abunelik' );
const qebzlerBtn = document.getElementById( 'qebzler' );
